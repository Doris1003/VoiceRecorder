            ...
            public void onInfo(MediaRecorder mr, int what, int extra) {
                switch (what){
                    ...
                    case MediaRecorder.MEDIA_RECORDER_INFO_MAX_DURATION_REACHED:
                        Toast.makeText(MainActivity.this, "已达到最大录制长度，开始重新录制", Toast.LENGTH_SHORT).show( );
                        startRecording();
                        break;
                    case MediaRecorder.MEDIA_RECORDER_INFO_MAX_FILESIZE_REACHED:
                        Toast.makeText(MainActivity.this, "空间不足，无法录制", Toast.LENGTH_SHORT).show();
                        mediaRecorder.stop();
                        break;
